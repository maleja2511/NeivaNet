"""
Django settings for NeivaNet project.
...
SECRET_KEY = 'django-insecure-v4w$c3ydlyidudk=w^q=_!v55h0k#2w_%t8mk2c_(2wflr3eb5'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'posts.context_processors.categories_ranking',
            ],
        },
    },
]

WSGI_APPLICATION = 'NeivaNet.wsgi.application'
